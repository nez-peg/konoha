...
//
//public class DynamicCallSite0 extends MutableCallSite {
...
//		try {
//			return MethodHandles.lookup().findVirtual(DynamicCallSite0.class, "fallbackFor" + name, type);
//		} catch (Throwable e) {
//			e.printStackTrace();
//			System.exit(1);
//		}
...
//		try {
//			return MethodHandles.lookup().findStatic(DynamicCallSite0.class, "testFor" + name, type);
//		} catch (Throwable e) {
//			e.printStackTrace();
//			System.exit(1);
//		}
...
//		return new Handle(Opcodes.H_INVOKESTATIC, Type.getType(DynamicCallSite0.class).getInternalName(), bsmName, methodDesc.getDescriptor());
//	}
//
//	/**
//	 * 
...
//
//	public DynamicCallSite0(MethodHandles.Lookup lookup, String targetName, MethodHandle fallbackHandle, MethodType methodType) {
//		this(lookup, targetName, fallbackHandle, methodType, true);
//	}
//
//	public DynamicCallSite0(MethodHandles.Lookup lookup, String targetName, MethodHandle fallbackHandle, MethodType methodType, boolean collectAsArray) {
//		super(methodType);
...
//		return new DynamicCallSite0(lookup, methodName, fbInstanceMethodHandle, type);
//	}
//
...
//		// if (argSize == paramClasses.length &&
//		// this.targetName.equals(method.getName())) {
//		// int i = 0;
//		// for (; i < argSize; i++) {
//		// Class<?> paramClass = paramClasses[i];
//		// Object arg = args[i + 1];
//		// if (!paramClass.isInstance(arg) &&
//		// !paramClass.equals(getUnwrappedClass(arg.getClass()))) {
//		// break;
//		// }
//		// }
//		// if (i == argSize) {
...
//		return new DynamicCallSite0(lookup, fieldName, fbGetterHandle, type, false);
//	}
//
...
//		return new DynamicCallSite0(lookup, fieldName, fbSetterHandle, type, false);
//	}
//
